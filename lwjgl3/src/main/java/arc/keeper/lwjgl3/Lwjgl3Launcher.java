...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("Thumbkeeper");
        ...
        // Portrait window that mirrors a typical phone aspect ratio (9:16) for desktop testing.
        configuration.setWindowedMode(405, 720);
        configuration.setWindowSizeLimits(270, 480, -1, -1);
